...
public class QingjingxuexiLiuyanEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public QingjingxuexiLiuyanEntity() {

	}

	public QingjingxuexiLiuyanEntity(T t) {
		try {
    ...
    public String toString() {
        return "QingjingxuexiLiuyan{" +
            "id=" + id +
            ", qingjingxuexiId=" + qingjingxuexiId +
            ", yonghuId=" + yonghuId +
            ", qingjingxuexiLiuyanText=" + qingjingxuexiLiuyanText +
