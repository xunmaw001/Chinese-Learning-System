...
public class ChengyuxuexiCollectionView extends ChengyuxuexiCollectionEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 类型的值
		*/
		private String chengyuxuexiCollectionValue;
	...
	public ChengyuxuexiCollectionView() {

	}

	public ChengyuxuexiCollectionView(ChengyuxuexiCollectionEntity chengyuxuexiCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, chengyuxuexiCollectionEntity);
			...
			* 获取： 类型的值
			*/
			public String getChengyuxuexiCollectionValue() {
				return chengyuxuexiCollectionValue;
			}
			/**
			* 设置： 类型的值
			*/
			public void setChengyuxuexiCollectionValue(String chengyuxuexiCollectionValue) {
				this.chengyuxuexiCollectionValue = chengyuxuexiCollectionValue;
			}
