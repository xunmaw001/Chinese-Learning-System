...
public class ShicixuexiCollectionView extends ShicixuexiCollectionEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 类型的值
		*/
		private String shicixuexiCollectionValue;
	...
	public ShicixuexiCollectionView() {

	}

	public ShicixuexiCollectionView(ShicixuexiCollectionEntity shicixuexiCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, shicixuexiCollectionEntity);
			...
			* 获取： 类型的值
			*/
			public String getShicixuexiCollectionValue() {
				return shicixuexiCollectionValue;
			}
			/**
			* 设置： 类型的值
			*/
			public void setShicixuexiCollectionValue(String shicixuexiCollectionValue) {
				this.shicixuexiCollectionValue = shicixuexiCollectionValue;
			}
