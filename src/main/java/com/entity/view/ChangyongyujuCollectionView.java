...
public class ChangyongyujuCollectionView extends ChangyongyujuCollectionEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 类型的值
		*/
		private String changyongyujuCollectionValue;
	...
	public ChangyongyujuCollectionView() {

	}

	public ChangyongyujuCollectionView(ChangyongyujuCollectionEntity changyongyujuCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, changyongyujuCollectionEntity);
			...
			* 获取： 类型的值
			*/
			public String getChangyongyujuCollectionValue() {
				return changyongyujuCollectionValue;
			}
			/**
			* 设置： 类型的值
			*/
			public void setChangyongyujuCollectionValue(String changyongyujuCollectionValue) {
				this.changyongyujuCollectionValue = changyongyujuCollectionValue;
			}
