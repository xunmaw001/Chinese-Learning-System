...
public class JichuCollectionView extends JichuCollectionEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 类型的值
		*/
		private String jichuCollectionValue;
	...
	public JichuCollectionView() {

	}

	public JichuCollectionView(JichuCollectionEntity jichuCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, jichuCollectionEntity);
			...
			* 获取： 类型的值
			*/
			public String getJichuCollectionValue() {
				return jichuCollectionValue;
			}
			/**
			* 设置： 类型的值
			*/
			public void setJichuCollectionValue(String jichuCollectionValue) {
				this.jichuCollectionValue = jichuCollectionValue;
			}
