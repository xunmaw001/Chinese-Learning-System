...
public class QingjingxuexiCollectionView extends QingjingxuexiCollectionEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 类型的值
		*/
		private String qingjingxuexiCollectionValue;
	...
	public QingjingxuexiCollectionView() {

	}

	public QingjingxuexiCollectionView(QingjingxuexiCollectionEntity qingjingxuexiCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, qingjingxuexiCollectionEntity);
			...
			* 获取： 类型的值
			*/
			public String getQingjingxuexiCollectionValue() {
				return qingjingxuexiCollectionValue;
			}
			/**
			* 设置： 类型的值
			*/
			public void setQingjingxuexiCollectionValue(String qingjingxuexiCollectionValue) {
				this.qingjingxuexiCollectionValue = qingjingxuexiCollectionValue;
			}
