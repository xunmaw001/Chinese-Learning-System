            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">常用语句登记</li>
                    </ol>
                </div>
            </div>
        </div>
...
<script>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "changyongyuju/info/" + id,
    ...
    function setDownloadBtn() {
        var changyongyujuFileUrl = "download('" + ruleForm.changyongyujuFile + "')";
        $("#changyongyujuFile").attr("onclick", changyongyujuFileUrl);
