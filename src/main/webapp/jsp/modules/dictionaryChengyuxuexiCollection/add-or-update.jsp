...
<script>
    ...
    var tableName = "dictionaryChengyuxuexiCollection";
    ...
    function submit() {
        if (validform() == true && compare() == true) {
            ...
            data["dicCode"] = "chengyuxuexi_collection_types";
            data["dicName"] = "收藏表类型";
    ...
    function getDetails() {
        ...
        if (adddictionary != null && adddictionary != "" && adddictionary != "null") {
            ...
            $(validform());
            $('#submitBtn').text('新增');
            httpJson("dictionary/maxCodeIndex" , "POST", {"dicCode":"chengyuxuexi_collection_types"}, (res) => {
                if(res.code == 0){
