            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">常用语句收藏登记</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 级联表所有字段 -->
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input style="width: 450px" id="changyongyujuUuidNumber" name="changyongyujuUuidNumber" class="form-control"
                                                   v-model="ruleForm.changyongyujuUuidNumber" readonly>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input style="width: 450px" id="changyongyujuName" name="changyongyujuName" class="form-control"
                                                   v-model="ruleForm.changyongyujuName" readonly>
                                        </div>


                                    <div class="form-group col-md-6">
                                        <label>常用语句照片</label>
                                        <img id="changyongyujuPhotoImg" width="100" height="100">
                                    </div>

                                    <div class="form-group col-md-6">
                                        <label>视频</label>
                                        <input style="width: 450px" id="changyongyujuVideo" name="changyongyujuVideo" class="form-control"
                                               v-model="ruleForm.changyongyujuVideo" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="changyongyujuValue" name="changyongyujuValue" class="form-control"
                                               v-model="ruleForm.changyongyujuValue" readonly>
                                    </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            <label>点击次数</label>
                                            <input style="width: 450px" id="changyongyujuClicknum" name="changyongyujuClicknum" class="form-control"
                                                   v-model="ruleForm.changyongyujuClicknum" readonly>
                                        </div>
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <input id="changyongyujuId" name="changyongyujuId" v-model="ruleForm.changyongyujuId" readonly type="hidden">
                                <input id="yonghuId" name="yonghuId" v-model="ruleForm.yonghuId" readonly type="hidden">

                                <div class="form-group col-md-6">
                                    <label>类型</label>
                                    <input style="width: 450px" id="changyongyujuCollectionValue" name="changyongyujuCollectionValue" class="form-control"
                                           v-model="ruleForm.changyongyujuCollectionValue" readonly>
                                </div>
...
<script>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "changyongyujuCollection/info/" + id,
    ...
    function setContent() {
        ...
        if (ruleForm.changyongyujuContent != null && ruleForm.changyongyujuContent != 'null' && ruleForm.changyongyujuContent != '') {
            var changyongyujuContentUeditor = UE.getEditor('changyongyujuContentEditor');
                changyongyujuContentUeditor.ready(function () {
                    ...
                    changyongyujuContentUeditor.setDisabled('fullscreen');
            });
        }
    }
