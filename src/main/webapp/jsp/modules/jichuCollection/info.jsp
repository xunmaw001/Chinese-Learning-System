            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">基础收藏登记</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 级联表所有字段 -->
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input style="width: 450px" id="jichuUuidNumber" name="jichuUuidNumber" class="form-control"
                                                   v-model="ruleForm.jichuUuidNumber" readonly>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input style="width: 450px" id="jichuName" name="jichuName" class="form-control"
                                                   v-model="ruleForm.jichuName" readonly>
                                        </div>


                                    <div class="form-group col-md-6">
                                        <label>基础照片</label>
                                        <img id="jichuPhotoImg" width="100" height="100">
                                    </div>

                                    <div class="form-group col-md-6">
                                        <label>视频</label>
                                        <input style="width: 450px" id="jichuVideo" name="jichuVideo" class="form-control"
                                               v-model="ruleForm.jichuVideo" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="jichuValue" name="jichuValue" class="form-control"
                                               v-model="ruleForm.jichuValue" readonly>
                                    </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            <label>点击次数</label>
                                            <input style="width: 450px" id="jichuClicknum" name="jichuClicknum" class="form-control"
                                                   v-model="ruleForm.jichuClicknum" readonly>
                                        </div>
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <input id="jichuId" name="jichuId" v-model="ruleForm.jichuId" readonly type="hidden">
                                <input id="yonghuId" name="yonghuId" v-model="ruleForm.yonghuId" readonly type="hidden">

                                <div class="form-group col-md-6">
                                    <label>类型</label>
                                    <input style="width: 450px" id="jichuCollectionValue" name="jichuCollectionValue" class="form-control"
                                           v-model="ruleForm.jichuCollectionValue" readonly>
                                </div>
...
<script>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "jichuCollection/info/" + id,
    ...
    function setContent() {
        ...
        if (ruleForm.jichuContent != null && ruleForm.jichuContent != 'null' && ruleForm.jichuContent != '') {
            var jichuContentUeditor = UE.getEditor('jichuContentEditor');
                jichuContentUeditor.ready(function () {
                    ...
                    jichuContentUeditor.setDisabled('fullscreen');
            });
        }
    }
