...
var centerMenu = [
    ...
    ,{
        name: '常用语句收藏',
        url: '../changyongyujuCollection/list.jsp'
    }
    ,{
        name: '成语学习收藏',
        url: '../chengyuxuexiCollection/list.jsp'
    }
    ,{
        name: '基础收藏',
        url: '../jichuCollection/list.jsp'
    }
    ,{
        name: '情景学习收藏',
        url: '../qingjingxuexiCollection/list.jsp'
    }
    ,{
        name: '诗词学习收藏',
        url: '../shicixuexiCollection/list.jsp'
    }
...
var indexNav = [
    ...
    {
        name: '常用语句',
        url: './pages/changyongyuju/list.jsp'
    },
    {
        name: '成语学习',
        url: './pages/chengyuxuexi/list.jsp'
    },
    {
        name: '论坛',
    ...
    {
        name: '基础',
        url: './pages/jichu/list.jsp'
    },
    {
        name: '情景学习',
        url: './pages/qingjingxuexi/list.jsp'
    },
    {
        name: '诗词学习',
        url: './pages/shicixuexi/list.jsp'
    },

]

var adminurl =  "http://localhost:8080/zhongwenxuexixitong/jsp/login.jsp";
